...
export class AppComponent implements OnInit {
  ...
  isMenuOpen = false;  // Pour menu mobile

  // Profile COMPLET - Résout TS2339 pour location, summary, linkedin, etc.
  profile = {
    name: 'Salem Kamoun',
    ...
    summary: `Développeur expert avec 15 ans d'expérience, spécialisé en
    développement web et mobile (Ionic, Android & iOS, Angular Firebase) et en
    automatisation intelligente via n8n. Je transforme vos idées en applications
    mobiles performantes et j'optimise vos processus en créant des agents IA sur
    mesure. Mon expertise web complète me permet de livrer des solutions
    digitales innovantes et efficaces.`,
    skills: [
    ...
    experiences: [
      {
        ...
        description: `Développement d'applications web et mobiles avec Angular, Ionic, Firebase.
        Intégration d'automatisation IA via n8n pour analyse de données patients.
        UI responsive et mobile-friendly avec Angular Material et Bootstrap.
        Exemple : https://passonbuddy-b6f53.web.app/landing`
      },
      {
        company: 'passOnBuddy',
        ...
        location: 'Tunisie',
        description: `Plateforme de mise en relation professionnelle : "N'embauchez plus d'inconnu !"
        Connexion LinkedIn-freelancer.com pour publication rapide de tâches.
        Développement fullstack avec JavaScript et bases de données.`
      },
      {
        company: 'Refer',
        ...
        location: 'Tunisie',
        description: `Application mobile iOS/Android pour élargir le réseau LinkedIn.
        Technologies : JavaScript, TypeScript, Firebase, Ionic, Figma pour UI/UX.`
      },
      {
        company: 'Tedemis',
        ...
        description: `Développement de jeux concours pour Carrefour, Vogue, Disneyland Paris.
        Stack : PHP, MySQL, HTML/CSS, Zend Framework, méthodologie SCRUM.`
      },
      {
        company: 'Proxym-IT',
  ...
  // Nav click pour mobile : Close + scroll smooth
  onNavClick(targetHash: string): void {
    this.closeMenu();
    const targetId = targetHash.substring(1);  // #home -> home
  ...
  // HostListener pour TOUS clics sur liens # (desktop, logo, mobile)
  @HostListener('click', ['$event'])
  onClick(event: MouseEvent): void {
    const target = event.target as HTMLElement;
    const link = target.closest('a');
    if (link && (link.getAttribute('href') || '').includes('#') && !link.href.includes('linkedin')) {
      event.preventDefault();  // Empêche saut brusque
      ...
      this.closeMenu();  // Ferme menu mobile
    }
  }
}
